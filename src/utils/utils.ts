...
export const VALIDATOR_MINLENGTH = (minLength: number) => (value: string): ValidationResult => {
...
export const VALIDATOR_MAXLENGTH = (maxLength: number) => (value: string): ValidationResult => {
...
export const VALIDATOR_MIN = (minValue: number) => (value: string): ValidationResult => {
...
export const VALIDATOR_MAX = (maxValue: number) => (value: string): ValidationResult => {
...
export const validate = (value: string, validators: ((value: string) => ValidationResult)[]): ValidationResult => {
